...
public class ChatbotService {
    ...
    public ChatbotService(WebClient.Builder webClientBuilder) {
        this.webClient = webClientBuilder.baseUrl("https://171f-102-152-212-147.ngrok-free.app").build(); // Replace with your actual Python backend URL
    }
    ...
    public String welcoming(String threadId, float niveauIQ) {
        String message = String.format("Hey, I just passed the IQ test and I got %f", niveauIQ);

        // Send the message to the assistant and return the response
        return chatWithAssistant(threadId, message);
    }
}
