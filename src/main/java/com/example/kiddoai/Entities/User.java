...
public class User implements UserDetails {
    ...
    public User(String id, String nom, String prenom, String dateNaissance, String email, String password, float niveauIQ, float scoreTotal, String favoriteCharacter, String threadId) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
    ...
    public float getNiveauIQ() {
        return niveauIQ;
    }

    public void setNiveauIQ(float niveauIQ) {
        this.niveauIQ = niveauIQ;
    }
